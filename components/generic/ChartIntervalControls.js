  ...
  render() {
    ...
    return (
      <div className="chart-interval-controls">
        {/* <div className="radio">
          <label>
            <button value={1} checked={printInterval === 1} name="chart-interval-controls" onChange={this.handleChange} />
            1m
          </label>
        </div>
        <div className="radio">
          <label>
            <button value={5} checked={printInterval === 5} name="chart-interval-controls" onChange={this.handleChange} />
            5m
          </label>
        </div>
        <div className="radio">
          <label>
            <button type="radio" value={15} checked={printInterval === 15} name="chart-interval-controls" onChange={this.handleChange} />
            15m
            </label>
        </div> */}
