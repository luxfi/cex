      ...
      ["catch"](
        (function(_this) {
          return function(res) {
            ...
            try {
              res.data =
                (ref = res.responseText) != null
                  ? ref
                  : JSON.parse(res.xhr.responseText)
            } catch (error) {
              err = error
            }
  ...
  switch (name) {
    ...
    case "product":
      return sp(function(x) {
        ...
        return (
          "/product/" +
          ((ref = (ref1 = x.id) != null ? ref1 : x.slug) != null ? ref : x)
        )
      })
    case "variant":
      return sp(function(x) {
        ...
        return (
          "/variant/" +
          ((ref = (ref1 = x.id) != null ? ref1 : x.sku) != null ? ref : x)
        )
      })
    case "site":
      return function(x) {
        ...
        return (
          "/site/" +
          ((ref = (ref1 = x.id) != null ? ref1 : x.name) != null ? ref : x)
        )
      }
    default:
      return function(x) {
  ...
  account: {
    ...
    exists: {
      url: function(x) {
        ...
        return (
          "/account/exists/" +
          ((ref =
            (ref1 = (ref2 = x.email) != null ? ref2 : x.username) != null
              ? ref1
              : x.id) != null
            ? ref
            : x)
    ...
    updateOrder: {
      url: function(x) {
        ...
        return (
          "/account/order/" +
          ((ref = (ref1 = x.orderId) != null ? ref1 : x.id) != null ? ref : x)
        )
      },
      method: PATCH,
      expects: statusOk,
